...
main:	la    	$a0,str1			#
	...
	li	$t1,8				# i = 8
while:	andi 	$t2,$t0,0xF0000000		# while((value & 0xF0000000) == 0 && (i > 0))
	bne  	$t2,0,do			#
	ble  	$t1,0,do			#
	sll  	$t0,$t0,4			# value = value << 4
	subi 	$t1,$t1,1			# i--
	j    	while				# loop
do:	andi 	$t2,$t0,0xF0000000		# value & 0xF0000000
	srl  	$t3,$t2,28			# value & 0xF0000000 >> 28
	or   	$t2,$0,$t3			# digito = value & 0xF0000000 >> 28
	bgt  	$t2,9,else			# if(digito <= 9)
	...
	syscall
	j    	endif
endif:  sll  	$t0,$t0,4			# value = value << 4
	subi 	$t1,$t1,1			# i--
