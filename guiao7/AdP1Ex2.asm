		...
		.eqv	read_string,8
		.eqv	print_string,4
stri:		.asciiz "Enter a string: "
strii:		.asciiz "Enter a string to insert: "
str3:		.asciiz	"Enter a position: "
str4:		.asciiz "Original string: "
str5:		.asciiz "\nModified string: "
str6:		.asciiz "\n"
		.align 	2
str1:		.space 	100
...
main:		subi	$sp,$sp,4		# salvaguardar registos
		sw	$ra,0($sp)		#
		la	$a0,stri		#
		li	$v0,print_string	# 
		...
		la	$a0,str5		#
		li	$v0,print_string	#
		syscall				# print_string(Modified string: ")
		la	$a0,str1		#
		syscall				# print_string(str1)
		la	$a0,str6		#
